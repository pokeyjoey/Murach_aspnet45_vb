...
Partial Class CheckOut2
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim message As String = "Contact information" & vbCrLf &
            ...
            "    Date of birth: " & customer.Birthdate & vbCrLf &
            ...
            "Shipping address" & vbCrLf &
            "    Address: " & customer.ShippingAddress & vbCrLf &
            "    City: " & customer.ShippingCity & vbCrLf &
            "    State: " & customer.ShippingState & vbCrLf &
