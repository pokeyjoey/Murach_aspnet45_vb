Public Class CartItemList
	...
	Public Default Property Item(index As Integer) As CartItem
		Get
		...
		End Set
	End Property
	Public Default ReadOnly Property Item(id As String) As CartItem
		Get
			For Each c As CartItem In cartItems
				If c.Product.ProductID = id Then Return c
			Next
			Return Nothing
		End Get
	End Property
