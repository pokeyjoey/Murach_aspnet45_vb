...
Partial Class CheckOut
    ...
    Private Sub GetCustomerData()
        ...
        If rblContactVia.SelectedValue = "Twitter" Then customer.ContactViaTwitter = True
        If rblContactVia.SelectedValue = "Facebook" Then customer.ContactViaFacebook = True
        If rblContactVia.SelectedValue = "Text" Then customer.ContactViaText = True
        If rblContactVia.SelectedValue = "Email" Then customer.ContactViaEmail = True
