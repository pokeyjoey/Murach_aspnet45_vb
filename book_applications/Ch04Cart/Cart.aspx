...
<body>
    ...
    <section>
        <form id="form1" runat="server">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString='<%$ ConnectionStrings:HalloweenConnection %>' 
                SelectCommand="SELECT [Name], [ShortDescription], [LongDescription], [ImageFile], [UnitPrice], [ProductID] FROM [Products] ORDER BY [Name]"></asp:SqlDataSource>
        </form>
    </section>
</body>
</html>